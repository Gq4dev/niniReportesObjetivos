		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Analisis objetivos compradores",
									"targetURL": "#reportesobjetivos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reportesobjetivos-display": {
								"semanticObject": "reportesobjetivos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reportesobjetivos",
									"url": sap.ui.require.toUrl("reportesobjetivos")
								}
							}
						}
					}
